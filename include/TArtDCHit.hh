...
class TArtDCHit : public TArtDataObject {
 ...
 public:
  ...
  virtual void SetSTCCoef(Int_t i,Double_t val) { coef[i]=val; }
  ...
  virtual Double_t GetSTCCoef(Int_t i) { return coef[i]; }
  //  virtual Double_t* GetSTCCoef() { return coef; }// function overloaded
