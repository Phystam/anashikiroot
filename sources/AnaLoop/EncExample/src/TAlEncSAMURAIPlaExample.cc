...
bool TAlEncSAMURAIPlaExample::Calculate()
{
  ...
  if(pla){
    ...
    if(pla->GetTLRaw() < /*4095*/2^16-1 &&
      ...
      f3pla_dtcal = pla->GetTLCal() - pla->GetTRCal();
      f3pla_dtslw = pla->GetTLSlw() - pla->GetTRSlw();
    }
    if(pla->GetQLRaw() > 0 &&
       pla->GetQRRaw() > 0){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  1, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  1, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,1, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  1, f3pla_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  1, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  1, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,1, pla->GetTAveSlw());
  ...
  if(pla){
    ...
    if(pla->GetTLRaw() < /*4095*/2^16-1 &&
      ...
      f3plad_dtcal = pla->GetTLCal() - pla->GetTRCal();
      f3plad_dtslw = pla->GetTLSlw() - pla->GetTRSlw();
    }
    if(pla->GetQLRaw() > 0 &&
       pla->GetQRRaw() > 0){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  2, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  2, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,2, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  2, f3plad_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  2, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  2, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,2, pla->GetTAveSlw());
  ...
  if(pla){
    ...
    if(pla->GetTLRaw() < /*4095*/2^16-1 &&
      ...
      f5pla_dtcal = pla->GetTLCal() - pla->GetTRCal();
      f5pla_dtslw = pla->GetTLSlw() - pla->GetTRSlw();
    }
    if(pla->GetQLRaw() > 0 &&
       pla->GetQRRaw() > 0){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  8, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  8, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,8, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  8, f5pla_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  8, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  8, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,8, pla->GetTAveSlw());
  ...
  if(pla){
    ...
    if(pla->GetTLRaw() < /*4095*/2^16-1 &&
      ...
      f7pla_dtcal = pla->GetTLCal() - pla->GetTRCal();
      f7pla_dtslw = pla->GetTLSlw() - pla->GetTRSlw();
    }
    if(pla->GetQLRaw() > 0 &&
       pla->GetQRRaw() > 0){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  3, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  3, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,3, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  3, f7pla_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  3, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  3, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,3, pla->GetTAveSlw());
  ...
  if(pla){
    ...
    if(pla->GetTLRaw() < /*4095*/2^16-1 &&
      ...
      f13pla1_dtcal = pla->GetTLCal() - pla->GetTRCal();
      f13pla1_dtslw = pla->GetTLSlw() - pla->GetTRSlw();
    }
    if(pla->GetQLRaw() > 0 &&
       pla->GetQRRaw() > 0){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  4, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  4, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,4, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  4, f13pla1_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  4, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  4, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,4, pla->GetTAveSlw());
  ...
  if(pla){
    ...
    if(pla->GetTLRaw() < /*4095*/2^16-1 &&
      ...
      f13pla2_dtcal = pla->GetTLCal() - pla->GetTRCal();
      f13pla2_dtslw = pla->GetTLSlw() - pla->GetTRSlw();
    }
    if(pla->GetQLRaw() > 0 &&
       pla->GetQRRaw() > 0){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  5, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  5, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,5, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  5, f13pla2_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  5, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  5, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,5, pla->GetTAveSlw());
  ...
  if(pla){
    ...
    if(pla->GetTLRaw() < /*4095*/2^16-1 &&
      ...
      f13sbv_dtcal = pla->GetTLCal() - pla->GetTRCal();
      f13sbv_dtslw = pla->GetTLSlw() - pla->GetTRSlw();
    }
    if(pla->GetQLRaw() > 0 &&
       pla->GetQRRaw() > 0){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  6, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  6, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,6, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  6, f13sbv_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  6, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  6, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,6, pla->GetTAveSlw());
  ...
  if(pla){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  9, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  9, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,9, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  9, f13sbv_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  9, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  9, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,9, pla->GetTAveSlw());
  ...
  if(pla){
    ...
    if(pla->GetTLRaw() < /*4095*/2^16-1 &&
      ...
      f7pla2_dtcal = pla->GetTLCal() - pla->GetTRCal();
      f7pla2_dtslw = pla->GetTLSlw() - pla->GetTRSlw();
    }
    if(pla->GetQLRaw() > 0 &&
       pla->GetQRRaw() > 0){
    ...
    fAnaLoop->Add(SAMURAIPLA, TLCal,  7, pla->GetTLCal());
    fAnaLoop->Add(SAMURAIPLA, TRCal,  7, pla->GetTRCal());
    fAnaLoop->Add(SAMURAIPLA, TAveCal,7, pla->GetTAveCal());
    fAnaLoop->Add(SAMURAIPLA, DTCal,  7, f7pla2_dtcal);
    fAnaLoop->Add(SAMURAIPLA, TLSlw,  7, pla->GetTLSlw());
    fAnaLoop->Add(SAMURAIPLA, TRSlw,  7, pla->GetTRSlw());
    fAnaLoop->Add(SAMURAIPLA, TAveSlw,7, pla->GetTAveSlw());
