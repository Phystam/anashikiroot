...
//  }
  ...
  if(pla){
    ...
    f13pla1_tlcal = pla->GetTLCal();
    f13pla1_trcal = pla->GetTRCal();
    f13pla1_tlslw = pla->GetTLSlw();
    f13pla1_trslw = pla->GetTRSlw();
  }
  ...
  if(pla){
    ...
    f13pla2_tlcal = pla->GetTLCal();
    f13pla2_trcal = pla->GetTRCal();
    f13pla2_tlslw = pla->GetTLSlw();
    f13pla2_trslw = pla->GetTRSlw();
  }
