...
public:
  TArtNEBULAPlaPara(Int_t id = -1, const TString& detname = "",
		    ...
		    Double_t tslwpow = -0.5,Double_t taveoffslw = 0, Double_t taveoffdelta = 0, Double_t taveofflight = 0,
		    Int_t ignore = 0)
    : TObject(),
    ...
    fTSlwPow(tslwpow), fTAveOffSlw(taveoffslw), fTAveOffDelta(taveoffdelta), fTAveOffLight(taveofflight),
      fIgnore(ignore)
  {
  ...
  void SetTSlwPow(Double_t val){fTSlwPow = val;} 
  void SetTAveOffSlw(Double_t val){fTAveOffSlw = val;}
  void SetTAveOffDelta(Double_t val){fTAveOffDelta = val;}
  void SetTAveOffLight(Double_t val){fTAveOffLight = val;}
  ...
  Double_t GetTSlwPow() const {return fTSlwPow;} 
  Double_t GetTAveOffSlw() const { return fTAveOffSlw;}
  Double_t GetTAveOffDelta() const { return fTAveOffDelta;}
  Double_t GetTAveOffLight() const { return fTAveOffLight;}
  ...
  friend std::ostream& operator<<(std::ostream& out, const TArtNEBULAPlaPara& p){
    ...
    out << "TSlew power: "  << p.fTSlwPow << std::endl;
    out << "TAve Offset Slew: "  << p.fTAveOffSlw << std::endl;
    out << "TAve Offset Delta: "  << p.fTAveOffDelta << std::endl;
    out << "TAve Offset Light: "  << p.fTAveOffLight << std::endl;
...
private:
  ...
  Double_t  fTSlwPow;
  Double_t  fTAveOffSlw;
  Double_t  fTAveOffDelta;
  Double_t  fTAveOffLight;
  Int_t     fIgnore;
