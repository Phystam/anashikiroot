...
class TArtCalibPlastic : public TArtReconstruction {
 ...
 public:
  ...
  TArtCalibPlastic(const TString outdataname = "BigRIPSPlastic");
  ...
  virtual void NearSearch(std::vector<int> tllist,std::vector<int> trlist,std::vector<int> tlid,std::vector<int> trid);
